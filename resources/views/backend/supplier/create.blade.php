            ...
            <div class="card-body">
              ...
              <p class="card-description">
                ...
                <div class="form-group">
                  ...
                  <input type="url" name="siteurl" value="{{ old('siteurl') }}" class="form-control" id="siteurl" placeholder="Website">
            ...
            <div class="card-body">
                ...
                <p class="card-description">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="fullname" value="{{ old('fullname') }}" class="form-control" id="fullname" placeholder="Name Representative">
